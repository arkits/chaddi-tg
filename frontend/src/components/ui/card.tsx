...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "surface-panel animate-rise rounded-2xl text-card-foreground transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/45",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-xl font-semibold leading-tight tracking-wide md:text-2xl",
      className
    )}
    {...props}
  />
